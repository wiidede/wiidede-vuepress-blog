...
```js
const timeTypes = [
  { key: 'date', value: 'date', label: '日', range: 365 },
  { key: 'week', value: 'week', label: '周', range: 52 },
  { key: 'month', value: 'month', label: '月', range: 12 },
  { key: 'quarter', value: 'month', label: '季度', range: 4 },
  { key: 'year', value: 'year', label: '年', range: 1 }
]
