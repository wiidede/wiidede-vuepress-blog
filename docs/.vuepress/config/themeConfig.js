...
module.exports = {
  ...
  social: {
    ...
    iconfontCssFile: '//at.alicdn.com/t/font_2587328_99lz0vkahy.css', // 可选，阿里图标库在线css文件地址，对于主题没有的图标可自由添加
    icons: [
      {
        iconClass: 'icon-mail',
        title: '发邮件',
  ...
  footer: {
    ...
    copyrightInfo:
      'Wiidede | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  },
